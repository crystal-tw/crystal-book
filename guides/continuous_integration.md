...
Another important thing to mention is that we are using `crystal init` to [create the application](../using_the_compiler/#產生一個專案或函式庫).
...
* I want to use [CircleCI](./ci/circleci.html)
